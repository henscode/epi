...
public class BinaryTreeLauncher {	
	public static void main(String[] args) {
	    ...
	    bt.printLevelOrderRecursion();
	    System.out.println("Level Order Using Queue Iterative: ");
	    bt.printLevelOrderIterativeLineByLine(one);
	    System.out.println();
	    System.out.println("preorder traversal: ");
	    bt.preorderTraversalPrint(one);
	    System.out.println();
	    System.out.println("inorder traversal: ");
	    bt.inorderTraversalPrint(one);
	    System.out.println();
	    System.out.println("inorder traversal Iterative: ");
	    bt.inorderTraversalPrintIterative(one);
	    System.out.println();
	    System.out.println("postorder traversal: ");
	    bt.postorderTraversalPrint(one);
	}
}
